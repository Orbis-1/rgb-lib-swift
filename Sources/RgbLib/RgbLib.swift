...
public protocol WalletProtocol: AnyObject, Sendable {
    ...
    func sendBegin(online: Online, recipientMap: [String: [Recipient]], donation: Bool, feeRate: UInt64, minConfirmations: UInt8, externalInputs: [ExternalInput]?, externalOutputs: [ExternalOutput]?) throws  -> String
...
open func sendBegin(online: Online, recipientMap: [String: [Recipient]], donation: Bool, feeRate: UInt64, minConfirmations: UInt8, externalInputs: [ExternalInput]?, externalOutputs: [ExternalOutput]?)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeRgbLibError_lift) {
    uniffi_rgblibuniffi_fn_method_wallet_send_begin(self.uniffiClonePointer(),
        ...
        FfiConverterUInt64.lower(feeRate),
        FfiConverterUInt8.lower(minConfirmations),
        FfiConverterOptionSequenceTypeExternalInput.lower(externalInputs),
        FfiConverterOptionSequenceTypeExternalOutput.lower(externalOutputs),$0
    )
})
}
...
public struct ExternalInput {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(txid: String, vout: UInt32, value: UInt64, scriptPubkey: String) {
        self.txid = txid
        self.vout = vout
        self.value = value
...
#if compiler(>=6)
extension ExternalInput: Sendable {}
#endif


extension ExternalInput: Equatable, Hashable {
    public static func ==(lhs: ExternalInput, rhs: ExternalInput) -> Bool {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeExternalInput: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ExternalInput {
        return
            try ExternalInput(
    ...
    public static func write(_ value: ExternalInput, into buf: inout [UInt8]) {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeExternalInput_lift(_ buf: RustBuffer) throws -> ExternalInput {
    return try FfiConverterTypeExternalInput.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeExternalInput_lower(_ value: ExternalInput) -> RustBuffer {
    return FfiConverterTypeExternalInput.lower(value)
}
...
#if compiler(>=6)
extension ExternalOutput: Sendable {}
#endif


extension ExternalOutput: Equatable, Hashable {
    public static func ==(lhs: ExternalOutput, rhs: ExternalOutput) -> Bool {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeExternalOutput: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ExternalOutput {
        return
            try ExternalOutput(
    ...
    public static func write(_ value: ExternalOutput, into buf: inout [UInt8]) {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeExternalOutput_lift(_ buf: RustBuffer) throws -> ExternalOutput {
    return try FfiConverterTypeExternalOutput.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeExternalOutput_lower(_ value: ExternalOutput) -> RustBuffer {
    return FfiConverterTypeExternalOutput.lower(value)
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionSequenceTypeExternalInput: FfiConverterRustBuffer {
    typealias SwiftType = [ExternalInput]?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterSequenceTypeExternalInput.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterSequenceTypeExternalInput.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionSequenceTypeExternalOutput: FfiConverterRustBuffer {
    typealias SwiftType = [ExternalOutput]?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterSequenceTypeExternalOutput.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterSequenceTypeExternalOutput.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeExternalInput: FfiConverterRustBuffer {
    typealias SwiftType = [ExternalInput]
    ...
    public static func write(_ value: [ExternalInput], into buf: inout [UInt8]) {
        ...
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeExternalInput.write(item, into: &buf)
        }
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [ExternalInput] {
        let len: Int32 = try readInt(&buf)
        var seq = [ExternalInput]()
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeExternalInput.read(from: &buf))
        }
        return seq
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeExternalOutput: FfiConverterRustBuffer {
    typealias SwiftType = [ExternalOutput]
    ...
    public static func write(_ value: [ExternalOutput], into buf: inout [UInt8]) {
        ...
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeExternalOutput.write(item, into: &buf)
        }
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [ExternalOutput] {
        let len: Int32 = try readInt(&buf)
        var seq = [ExternalOutput]()
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeExternalOutput.read(from: &buf))
        }
        return seq
    }
}
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_rgblibuniffi_checksum_method_wallet_send_begin() != 29935) {
        return InitializationResult.apiChecksumMismatch
    }
