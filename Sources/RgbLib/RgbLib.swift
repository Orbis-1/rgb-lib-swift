...
public protocol WalletProtocol: AnyObject, Sendable {
    ...
    func sendBegin(online: Online, recipientMap: [String: [Recipient]], donation: Bool, feeRate: UInt64, minConfirmations: UInt8, expirationTimestamp: UInt64?, dryRun: Bool, externalInputs: [ExternalInput]?, externalOutputs: [ExternalOutput]?) throws  -> SendBeginResult
...
open func sendBegin(online: Online, recipientMap: [String: [Recipient]], donation: Bool, feeRate: UInt64, minConfirmations: UInt8, expirationTimestamp: UInt64?, dryRun: Bool, externalInputs: [ExternalInput]?, externalOutputs: [ExternalOutput]?)throws  -> SendBeginResult  {
...
public struct ExternalInput: Equatable, Hashable {
...
public struct ExternalOutput: Equatable, Hashable {
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_rgblibuniffi_checksum_method_wallet_send_begin() != 51192) {
        return InitializationResult.apiChecksumMismatch
    }
